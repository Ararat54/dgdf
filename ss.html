...
<title>HTML Lion</title>

<meta name="Keywords" content="HTML,CSS,XML,JavaScript,jQuery,PHP,colors,tutorial,programming,development,training,learning,quiz,primer,lessons,reference,examples,source code,demos,tips,color table,cascading style sheets">

<meta name="Description" content="Free HTML CSS JavaScript jQuery XML PHP SQL tutorials, references, examples for web building.">
...
#header{ display:block; background:#FFF; padding:10px 20px; box-shadow:0 0px 2px rgba(000,000,000,0.2);  position:absolute; top:10px; left:10px; right:10px;}

#logo { display:inline-block; font-weight:300;  margin:0 0 0px; font-size:30px; line-height:24px;  color:#000; text-decoration:none; padding:30px 0 0 0 }
#logo span{ color:#0088cc;}
#logo i{  font-size:10px; background:#0088cc; color:#FFF; line-height:16px; padding:2px 2px; font-weight:600; outline:solid 1px #0088cc; outline-offset:1px;  vertical-align:middle; margin-left:5px; font-style:italic; display:inline-block;  }
#logo strong{ font-size:11px; line-height:14px; text-align:center; text-transform:uppercase; padding:2px 0 0 0; border-top:solid 1px #ccc; margin-top:5px; display:none; }


body.html { -webkit-text-size-adjust:100%; -moz-text-size-adjust:100%;  color:#000; background:#FFF url(../img/body.png); height:100%;}
#logo{ font-family: 'Open Sans', sans-serif;}



div.headeradds{float:right; }

#container{ display:block; height:auto; background:#fafafa; box-shadow:0 0px 2px rgba(000,000,000,0.2); position:absolute; left:10px; right:10px; top:130px; bottom:60px; }
.htmlCode { position:absolute;  display:block; height:99%;  width:48%; border:solid 1px #d3d3d3; resize:none; }
.htmlView { position:absolute; right:0;  display:block; height:99%;  width:48%; border:solid 1px #d3d3d3; background:#FFF;}
#codoContainer{ position:absolute; left:20px; top:40px; bottom:20px; right:20px; display:block; }
.editYourCode, .viewYourCode{ position:absolute; width:48%; top:-26px; left:0px; display:block; }
.viewYourCode{ left:auto; right:0}

#tryFooter{ position:absolute; background:#FFF; padding:5px 20px; box-shadow:0 0px 2px rgba(000,000,000,0.2); position:absolute; left:10px; right:10px; bottom:10px; text-align:center; height:23px; padding-top:7px}
...
$(function(){
  ...
  var chagesdocument = $('#chages').contents().get(0);
  chagesdocument.designMode = 'on';
  chagesdocument.open();
  chagesdocument.write($('#htmlCode').val());
  chagesdocument.close();
  chagesdocument.designMode = 'off';
	var thisData = $('#htmlCode').val()
	//$(".htmlView").html(thisData)
	
	$("#htmlCode").keyup(function(){
		  var thisData = $(this).val();
		  var chagesdocument = $('#chages').contents().get(0);
		  chagesdocument.open();
		  chagesdocument.write(thisData);
		  chagesdocument.close();
		  chagesdocument.designMode = 'off';
...
.wrap {text-align: center; margin: 0; padding: 0; background: url('https://dl.dropboxusercontent.com/s/d8izj7q336998yd/EKRAN_1-spaces.ru.png') repeat-x #ec008c; min-height: 100%; height:auto !important; height:100%;}
.header {height: 158px; width: 960px; margin-left: auto; margin-right: auto; background: url('2.jpg') no-repeat; position: relative;}
.forum-header {height: 158px; width: 960px; margin-left: auto; margin-right: auto; background: url('3.jpg') no-repeat; position: relative;}
...
<div class="editYourCode">GREL HTML</div>
...
.htmlCode:focus {
  outline: rgba(255,255,255,.4) 1000em solid;
} 
.htmlCode {
...
<textarea placeholder="<HTML>" class="htmlCode" id="htmlCode" spellcheck="false"></textarea>
...
<div class="viewYourCode"> NAYEL </div>
...
<iframe width="100%" height="100%" class="htmlView" id="chages">
